    ...
    <section class="wishlist">
        ...
        <div class="box-container">
            ...
            <form action="" method="POST" class="box">
                <a href="wishlist.php?delete=<?=$fetch_wishlist['id'];?>" class=
                "fas fa-times" onclick="return confirm('delete this from wishlist?')"></a>
                <a href="view_page.php?pid=<?=$fetch_wishlist['pid'];?>" class="fas fa-eye"></a>
                <img src="./image/<?=$fetch_wishlist['image'];?>" alt="">
        ...
        <div class="wishist-total">
            <p>grand total: <span>&#8369;<?=$grand_total;?>/-</span></p>
            <a href="shop.php" class="btn">continue shopping</a>
            <a href="wishlist.php?delete_all" class="delete-btn <?=($grand_total > 1)?:'enabled';?>">delete all</a>
        </div>
    </section>
